...
<head>
    ...
    <link rel="stylesheet" href="css/infoImg.css">
...
<jsp:include page="sezioni/header.jsp"/>
    <div class="content">
        ...
        <p>La missione principale dell'associazione è quella di promuovere la salvaguardia del mare attraverso l'educazione, la sensibilizzazione e l'azione concreta. Ciò significa che l'associazione si impegna a informare la gente sui problemi ambientali che riguardano il mare, come l'inquinamento, la pesca eccessiva, il cambiamento climatico e la perdita di habitat.</p>
        <hr>
        <h1>Come posso partecipare</h1>
        <p>L'associazione si propone anche di organizzare eventi e attività che coinvolgano la comunità locale, come pulizie delle spiagge e delle coste, conferenze, proiezioni di documentari e attività educative per le scuole. Inoltre, l'associazione collabora con altre organizzazioni ambientaliste e istituzioni pubbliche per promuovere politiche che tutelino l'ecosistema marino.</p>
        <hr>
        <h1>dove siamo?</h1>
    ...
    <div class="row">
        <div class="column">
            <img src="img/loveAir.png" class="image-button">
        </div>

        <div class="column">
            <img src="img/spiaggia.png" class="image-button">
        </div>

        <div class="column">
            <img src="img/rete.png" class="image-button">
        </div>
    </div>
